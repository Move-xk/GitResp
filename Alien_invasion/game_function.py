...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):  # 删除消失的子弹
    bullets.update()
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):  # 释放被子弹击中的外星人
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):  # 飞船碰撞后清空，状态重置
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):  # 检查外星人是否在屏幕边缘
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):  # 检查飞船和外星人的碰撞
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):  # 更新屏幕上的所有元素
